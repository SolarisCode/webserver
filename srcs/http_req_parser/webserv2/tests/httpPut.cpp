...
void httpPut()
{
    ...
    std::string formUrlEncodedRequest = "PUT /update-data HTTP/1.1\r\n"
    ...
    // JSON Data
    std::string jsonRequest = "PUT /api/resource/123 HTTP/1.1\r\n"
    ...
    // XML Data
    std::string xmlRequest = "PUT /api/update-info HTTP/1.1\r\n"
                             "Host: api.example.com\r\n"
