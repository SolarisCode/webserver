...
void httpPost()
{
    ...
    std::string formUrlEncodedRequest = "POST /submit-form HTTP/1.1\r\n"
    ...
    // JSON Data
    std::string jsonRequest = "POST /api/users HTTP/1.1\r\n"
    ...
    // Multipart Form Data
    std::string multipartFormDataRequest = "POST /upload-file HTTP/1.1\r\n"
    ...
    // XML Data
    std::string xmlRequest = "POST /api/xml-data HTTP/1.1\r\n"
                             "Host: api.example.com\r\n"
    ...
    std::string binaryDataRequest = "POST /upload-image HTTP/1.1\r\n"
    ...
    std::string chunkedBinaryDataRequest = "POST /upload-image HTTP/1.1\r\n"
                                           "Host: images.example.com\r\n"
                                           "Content-Type: image/jpeg\r\n"
